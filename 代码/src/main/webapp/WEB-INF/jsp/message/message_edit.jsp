	...
	<div class="easyui-layout"
		...
		<div class="easyui-layout"
			...
			<div id="content" region="center" title="群发信息" style="padding: 5px;">
				<div id="myDIV" style="display: none;">${message.appList}</div>
					...
					<div style="padding: 10px 60px 20px px;">
						<form id="ff" enctype="multipart/form-data">
							<table cellpadding="5">
								...
								<input type="hidden" value="${message.cover}" name="cover" />
								<tr>
									<td>群发公众号:</td>
							...
							{field:'appSecret',title:'开发者秘钥',width:80,align:'right'},]],fitColumns: true">
								...
								<tr>
									...
									<td><input class="easyui-textbox" type="text" name="title"
										data-options="required:true" value="${message.title}"></input></td>
								</tr>
								<tr>
									<td>作者:</td>
									<td><input class="easyui-textbox" type="text"
										name="author" data-options="required:true"
										value="${message.author}"></input></td>
								</tr>
								<tr>
									<td>原文url:</td>
									<td><input class="easyui-textbox" type="text"
										name="articleUrl" data-options="required:true"
										value="${message.articleUrl}"></input></td>
								</tr>
								<tr>
									<td>内容简介</td>
									<td><input class="easyui-textbox" type="text"
										name="summary" data-options="required:true"
										value="${message.summary}"></input></td>
								</tr>
								<tr>
									<td>内容:</td>
									<td><textarea name="content" id="info"
											style="border: 1px; width: 700px; height: 400px; visibility: hidden;">${message.content}</textarea></td>
								</tr>
								<tr>
									<td>封面图</td>
									<td><input type="file" id="uploadId" name="sourceFile"
										style="width: 200px"> <img id="imageview"
										width="300px" height="300px" src="${message.cover}" /></td>
								</tr>
							</table>
						</form>
						<div style="padding: 5px">
							<a href="javascript:void(0)" class="easyui-linkbutton"
								...
								onclick="submitForm3()">存草稿</a> <a href="javascript:void(0)"
