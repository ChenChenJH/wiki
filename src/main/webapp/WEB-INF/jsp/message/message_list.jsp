...
<script type="text/javascript">
	...
	function editMessage() {
		...
		if (row) {
			location.href = 'message/getMessage?id=' + row.id;
...
<body>
	...
	<div class="easyui-layout"
		...
		<div class="easyui-layout"
			...
			<!--右边主要内容模块-->
			<div id="content" region="center" title="已发送" style="padding: 5px;">
				<table id="dg" class="easyui-datagrid"
					style="width: 850px; height: 370px"
					data-options="rownumbers:true,pagination:true,pageSize:10,singleSelect:true,url:'message/getMessageList',method:'get',toolbar:'#tb'">
					<thead>
						<tr>
				...
				<div id="tb" style="padding: 5px; height: auto">
					<div style="margin-bottom: 5px">
						<a class="easyui-linkbutton" iconCls="icon-edit" plain="true"
							onclick="editMessage()">详情</a> <a class="easyui-linkbutton"
							iconCls="icon-cut" plain="true" onclick="destroyMessage()">删除</a>
					</div>
					<div>
