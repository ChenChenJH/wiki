							...
							{field:'appSecret',title:'开发者秘钥',width:80,align:'right'},]],fitColumns: true">
								...
								<tr>
									...
									<td><input class="easyui-textbox" type="text" name="title"
										id="title" value="${draft.title}"></input></td>
								</tr>
								<tr>
									<td>作者:</td>
									<td><input class="easyui-textbox" type="text" id="author"
										name="author" value="${draft.author}"></input></td>
								</tr>
								<tr>
									<td>原文url:</td>
									<td><input class="easyui-textbox" type="text"
										id="articleUrl" name="articleUrl" value="${draft.articleUrl}"></input></td>
								</tr>
								<tr>
									<td>内容简介</td>
									<td><input class="easyui-textbox" type="text" id="summary"
										name="summary" value="${draft.summary}"></input></td>
								</tr>
								<tr>
									<td>内容:</td>
								...
								<tr>
									...
									<td><input type="file" id="uploadId" name="sourceFile"
										value="${draft.cover}" style="width: 200px"> <img
										id="imageview" width="300px" height="300px"
										src="${draft.cover}" /></td>
								</tr>
							</table>
						</form>
